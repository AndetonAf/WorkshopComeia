...
namespace Workshop.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade")] Funcionario funcionario)
        {
